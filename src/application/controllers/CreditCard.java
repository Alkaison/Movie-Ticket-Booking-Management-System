...
public class CreditCard{
    ...
    public void initialize() {
        ...
        getMoviePrice();
        childcomponent.layoutXProperty().bind(parentcomponent.widthProperty().subtract(childcomponent.widthProperty()).divide(2));
        childcomponent.layoutYProperty().bind(parentcomponent.heightProperty().subtract(childcomponent.heightProperty()).divide(2));
    }

    public void getMoviePrice(){
        // Function  to Get Movie Price
        MoviePrice.setText("Rs. 278.00");
    }

    // Handle Cancel BUtton
    @FXML
    void HandleCancelButton(ActionEvent event) {
        root = FXMLLoader.load(getClass().getResource("/application/fxml/SelectSeats.fxml"));
